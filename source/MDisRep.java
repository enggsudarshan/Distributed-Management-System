...
import java.util.*;
public class MDisRep extends HttpServlet
{
public void doPost(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
{
	...
	try{
		...
		ResultSet rs=null;
		out.println("<html><title>Distributor Sales Report Page</title> <style>");	
		...
		out.println("<center><h2><font color='blue'>Distributor's Sales Details </font></h2>");
		out.println("<img src='http://localhost:8080/dms/images/redline.gif'>");
		out.println("<FORM METHOD=post ACTION='http://localhost:8080/servlet/MDisRep1'>");
		...
		out.println("<image src='http://localhost:8080//dms//images//home1.gif' width='90%'></a></td></tr></table></center>");
