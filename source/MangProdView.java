...
public class MangProdView extends HttpServlet
{
public void doGet(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
{
	...
	try{
		...
		out.println("</table><br><table><tr><td><a href='http://localhost:8080/servlet/ManagerSign'><img src='http://localhost:8080/dms/images//back_1.gif'></a>");
