...
public class DisSRRep extends HttpServlet
{
public void doPost(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
{
	...
	try{
		...
		out.println("</script>");
		out.println("<center><h1><font color='blue'>Sales Representative Sales Report </font></h1>");
		out.println("<hr size=6 color='maroon'>");
		out.println("<body bgcolor='E9FFB9'>");
		out.println("<FORM METHOD=post ACTION='http://localhost:8080/servlet/DisSRRep1'>");
		out.println("<center>");
